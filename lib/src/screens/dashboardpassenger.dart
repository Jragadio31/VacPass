...
class DashboardScreen extends State<Dashboard> {
 ...
 Map data;
  ...
  String convertDate  (Timestamp time){
    ...
    DateTime _dateType = _date.toDate();
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(convertDate(data['Date_of_Vaccination']),style: TextStyle( fontSize: 20)),
                                ]
                              ),
                              SizedBox(height:20),
                              Row(
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(data['Brand_number'],style: TextStyle( fontSize: 20)),
                                ]
                              ),   
                              SizedBox(height:120),
                              Row(
